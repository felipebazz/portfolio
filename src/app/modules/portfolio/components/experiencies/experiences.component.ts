...
import { IExperiences } from '../../interfaces/experience.interface';
...
export class ExperienciesComponent {
  public arrayExperiences = signal<IExperiences[]>([
    ...
    },
    {
      ...
      text: `<p>Iniciei meu segundo desafio no time de implantação do sistema de previdência, um software de plateleira, legado, mas rico em funcionalidades que era muito comercializado, eu realizava modificações e adaptações conforme negociado com o cliente,
    ...
    },
    {
      ...
      text: `<p style="text-align:justify">Em minha primeira experiência como desenvolvedor, iniciei desenvolvendo aplicações para automatizar tarefas e processos da empresa, diminuindo o tempo de resposta dos colaboradores para os fornecedores.
