...
export class ExperiencesConfig {
    static readonly experiences = signal<IDetails[]>([
    {
      ...
      description: `<p>Iniciei este desafio na consultoria, alocado no cliente Roche, onde tive a oportunidade de trabalhar exclusivamente no front-end com Angular, onde evolui bastante e em uma equipe de 5 colaboradores, desenvolvemos e entregamos
      ...
      <p>
      Após o fim do contrato com o cliente, inciei no cliente Itaú Unibanco, onde fiquei resposável pelo desenvolvimento front-end de um sistema de compra e venda de ativos.
    ...
    },
    {
      ...
      description: `<p>Iniciei meu segundo desafio no time de implantação do sistema de previdência, um software de plateleira, legado, mas rico em funcionalidades que era muito comercializado, eu realizava modificações e adaptações conforme negociado com o cliente,
      ...
      outros clientes a ficar responsável por todas a suas solicitações, onde eu não era mais do setor de implantação, e sim, atendimento.
      </p>`,
      stacksIds: [
        EStacksAndTools.Csharp,
    ...
    },
    {
      ...
      description: `<p style="text-align:justify">Em minha primeira experiência como desenvolvedor, iniciei desenvolvendo aplicações para automatizar tarefas e processos da empresa, diminuindo o tempo de resposta dos colaboradores para os fornecedores.
      ...
      para que o hotel apresentasse seus benefícios e valores, assim agilizando a forma como a empresa negociava com hotéis.</p>
      <p>Além do desenvolvimento de novas aplicações, eu também realizava o monitoramento de processos, do sistema legado, e quando necessário, realizava manutenção dele.</p>`,
      stacksIds: [
